    ...
    return (
        <div>
            <div className="flex justify-center">
                <img src={ImageMenu} alt="imagen de platillos" className="max-w-[300px] min-w-[160px]" />
            </div>
            ...
            <div className="flex justify-center w-full text-center font-bold text-2xl">Menú</div>
