...
const SearchReservation = () => {
  ...
  useEffect(() => {
    if (bool === true) {
      ...
      setResponseReservation(
        <tbody>
          <tr>
            <td className="text-center px-2 py-1 text-color-secondary border-t-2 border-l-2 border-b-2 border-color-secondary">
              {" "}
              Código:{" "}
            </td>
            <td className="text-center px-2 py-1 border-t-2 border-r-2 border-b-2 border-color-secondary">
              {" "}
              {reservation.code}{" "}
            </td>
          </tr>
          <tr>
            ...
            <td className="text-center px-2 py-1 border-t-1 border-r-1 border-b-1 border-color-secondary flex justify-center items-center">
              {" "}
              <CardStatus status={reservation.status} />
            </td>
          </tr>
          <tr>
            <td className="text-center px-2 py-1 text-color-secondary border-t-2 border-l-2 border-b-2 border-color-secondary">
          ...
          <tr>
            ...
            <td className="text-center px-2 py-1 border-t-2 border-r-2 border-b-2 border-color-secondary">
              {" "}
              {reservation.owner_phone_number}{" "}
            </td>
          </tr>
          <tr>
            <td className="text-center px-2 py-1 text-color-secondary border-t-2 border-l-2 text-wrap border-b-2 border-color-secondary">
              {" "}
              Email:{" "}
            </td>
            <td className="text-center px-2 py-1 border-t-2 border-r-2 border-b-2 border-color-secondary">
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center py-5">
      <h1 className="text-3xl text-color-secondary font-bold text-center px-2">
        Buscar una Reserva
      </h1>
