...
const CardProduct = ({name, description, image, price, disabled}) => {
    ...
    if(disabled){
        disabledStyle = (<div className="absolute inset-0 rounded-t-2xl bg-black opacity-70 flex items-center justify-center"><span className="text-3xl font-bold text-red-900 opacity-100 -rotate-45">No Disponible</span></div>);
    }
    return (
